...
write_menu_row("fire_assignments.php", "onmouseover=show_window('fire_popup'); onmouseout=hide_window('fire_popup')", "Fire Assignments");

write_menu_row("http://www.avuedigitalservices.com", "onmouseover=show_window('emp_popup'); onmouseout=hide_window('emp_popup')", "Employemnt");

write_menu_row("image_viewer.php", "onmouseover=show_window('images_popup'); onmouseout=hide_window('images_popup')", "Pictures");
